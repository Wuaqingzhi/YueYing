...
internal object TextCipher {
    ...
    private const val P_YUEYINGAPP = "OiDOPwetWeJvnA8z8SrHYgA6xkgXtlvadoI="
    private const val P_MAINACT = "OiDOPwetWeJvnA8z8SrHYhQuyn8/u0jycJscZA=="
    ...
    private const val D_BODY = "v9MP9MRM2w+uF8aRdd8fqdzCS6XHN4AX407o+yrKUtDpqj6RkWSm83KGGG6qdZgrMDvLZBz2X/Rr3T9o8SveIj41y3hRgUn+X5sGenPaNaTS6kWT1jyHFe9v9vg+wlHa4KkbsZdZr3OIRY2SBr8O+rHtCPnYWdoqhBbThXjuDqPlw0u+yj6kFeBwwPko0V/x5KsZl5Z6l3ypU46JKb0tyL7GK/fidNMnihrHqnfxPKnU/EacxjCBJuVy6g=="
    ...
    private const val D_URL = "MTvXYQ3iE7Rhmxx15TiZLzYijEYLuU3yaJUSdfl17jk8Fsp/GQ=="
    ...
    val pYueyingApp get() = dec(P_YUEYINGAPP)
