...
import com.yueying.app.util.TextCipher
...
internal fun entryMismatch(ctx: Context): Boolean {
    val app = TextCipher.pYueyingApp
...
class YueYingApp : Application() {
    ...
    override fun onCreate() {
        ...
        com.yueying.app.data.network.XunleiDeviceFingerprint.init(this)
    }
}

private fun scheduleDeepScan(ctx: Context) {
    val prefs = ctx.getSharedPreferences("yueying_settings", Context.MODE_PRIVATE)
