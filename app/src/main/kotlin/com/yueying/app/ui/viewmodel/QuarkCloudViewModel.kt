...
class QuarkCloudViewModel(
    ...
    private fun downloadHeaders(cookie: String): Map<String, String> = mapOf(
        "Cookie" to cookie,
        "User-Agent" to com.yueying.app.data.network.QuarkConstants.API_USER_AGENT,
        "Referer" to com.yueying.app.data.network.QuarkConstants.DOWNLOAD_REFERER
    )
            ...
            try {
                ...
                tasks.forEachIndexed { index, (file, relPath) ->
                    ...
                    runCatching {
                        ...
                        val effectiveUrl = com.yueying.app.data.network.QuarkCdn.fastest(link.downloadUrl, cookie)
