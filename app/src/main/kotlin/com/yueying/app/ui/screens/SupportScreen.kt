...
/** 将内置捐赠码解码为 Bitmap 并保存到系统相册（Android 10+ 走 MediaStore，无需权限） */
private fun saveQrToGallery(context: Context, drawableId: Int, namePrefix: String): Boolean = runCatching {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
        val values = ContentValues().apply {
            ...
            put(MediaStore.Images.Media.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/YueYing")
